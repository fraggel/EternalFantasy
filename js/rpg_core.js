...
//-----------------------------------------------------------------------------
/**
 * The weather effect which displays rain, storm, snow or sand.
 *
 * @class Weather
 * @constructor
 */
...
Weather.prototype.initialize = function() {
    ...
    /**
     * The type of the weather in ['none', 'rain', 'storm', 'snow', 'sand'].
     *
     * @property type
     * @type String
     */
...
Weather.prototype._createBitmaps = function() {
    ...
    this._sandBitmap = new Bitmap(1, 60);
    this._sandBitmap.fillAll('yellow');
};
...
Weather.prototype._updateSandSprite = function(sprite) {
    ...
    sprite.ax -= 80 * Math.sin(sprite.rotation);
    sprite.ay += 80 * Math.cos(sprite.rotation);
